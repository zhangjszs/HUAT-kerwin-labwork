...
<CodePreview src="/code-snippets/ml-practice/data_exploration.py" lang="python" caption="Data Exploration - Loading, EDA & Visualization" />

### 特征工程

<CodePreview src="/code-snippets/ml-practice/feature_engineering.py" lang="python" caption="Feature Engineering - Title Extraction & Family Size" />
