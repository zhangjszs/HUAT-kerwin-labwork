...
| 课程                                      | 目录            | 技术栈 |
| ----------------------------------------- | --------------- | ------ |
| [数据采集与预处理](数据采集与预处理/)     | Python          |
| [数据分析与可视化](数据分析与可视化/)     | Python, Jupyter |
| [数据分析课设](数据分析与可视化课程设计/) | Python, Pandas  |
...
| [Java 课程作业](schoolJavaHomework/) | Java               |
| [Java 课程设计](java课程设计/)       | Java, Swing        |
| [JavaWeb 课设](javaweb课设/)         | Spring Boot, MySQL |

### 系统编程

| 课程                              | 目录     | 技术栈 |
| --------------------------------- | -------- | ------ |
| [C 语言课设](C语言课设/)          | C, CMake |
| [微机原理与接口](微机原理和接口/) | Assembly |
| [Linux 系统应用](linux系统应用/)  | Shell, C |
...
| 课程                                | 目录          | 技术栈 |
| ----------------------------------- | ------------- | ------ |
| [嵌入式系统](嵌入式系统原理与应用/) | C, ARM        |
| [Android 开发](android移动开发/)    | Java, Android |
| [软件工程](软件工程/)               | UML, Java     |
| [项目管理](项目工程管理/)           | -             |
